...
export const NewTask = () => {
  ...
  return (
    ...
    >
      ...
      <Card
        title=""
        className="flex p-0 flex-col items-end py-[36px] px-[44px] gap-[40px] w-[1166px] h-[576px] shadow-[0_4px_16px_0_rgba(0,0,0,0.16)] rounded-[20px] pt-[36px] "
      >
        {/* Frame 184 */}
        ...
        <div className="flex flex-row justify-between  items-center gap-[670px] w-[1078px] h-[50px]">
          <div className="flex flex-row justify-start items-center gap-[24px] w-[272px] h-[50px]">
            <div className="cursor-pointer" onClick={handleFlagOpen}>
            ...
            <div className="cursor-pointer" onClick={handleDatePickerOpen}>
                  ...
                  <div className="flex flex-row w-[153px] overflow-scroll gap-2">
                    {tag.map((item) => (
                      <div
                        ...
                        ref={tagHover}
                        id={item.id}
                        onMouseEnter={() => handleTagEditHover(item.id)}
                        onMouseLeave={() => handleTagEditHoverLeave(item.id)}
                      ...
                      >
                        {!item.editFlag ? (
                          ...
                          <div className=" w-[54px] flex flex-row justify-between items-center">
                            <i onClick={() => handleClickCloseTag(item)}>
                              {icons.CloseTagIcon}
                            </i>
